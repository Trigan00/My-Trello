            ...
            >
                ...
                >
                  <div className="panel-body">
                    <p className="mbr-fonts-style panel-text display-7">
                      Trackker — это ваш личный помощник в мире задач! Он создан
                      для студентов и небольших IT команд, чтобы упростить
                      таск-менеджмент.
                    </p>
                  </div>
                </div>
              ...
              <div className="card">
                ...
                >
                  <div className="panel-body">
                    <p className="mbr-fonts-style panel-text display-7">
                      Получайте уведомления и управляйте задачами прямо в
                      Telegram! Удобно, не правда ли?
                    </p>
                  </div>
                </div>
              </div>
              <div className="card">
                ...
                >
                  <div className="panel-body">
                    <p className="mbr-fonts-style panel-text display-7">
                      Наш AI бот поставит задачу прямо из голосового сообщения!
                    </p>
                  </div>
                </div>
              </div>
