...
!(function (t, e) {
	...
	var ae = re(),
		le = re({ defaultModifiers: [Mt, ee, jt, ft] }),
		ce = re({ defaultModifiers: [Mt, ee, jt, ft, te, Qt, ie, Nt, Jt] }),
		de = Object.freeze({
			__proto__: null,
			popperGenerator: re,
			detectOverflow: Yt,
	...
	class ye extends R {
		...
		static dataApiKeydownHandler(e) {
			...
			if ('Escape' === e.key) return n().focus(), void ye.clearMenus()
			i || ('ArrowUp' !== e.key && 'ArrowDown' !== e.key)
				? i && 'Space' !== e.key
					? ye.getInstance(n())._selectMenuItem(e)
					: ye.clearMenus()
				: n().click()
		}
	}
	...
	class xe {
		...
		_getConfig(t) {
			return (
				((t = { ...ke, ...('object' == typeof t ? t : {}) }).rootElement =
	...
	const De = { backdrop: !0, keyboard: !0, focus: !0 },
		Ne = { backdrop: '(boolean|string)', keyboard: 'boolean', focus: 'boolean' }
	class Se extends R {
		constructor(e, i) {
			super(e),
				(this._config = this._getConfig(i)),
		...
		_getConfig(t) {
			return (
				(t = { ...De, ...U.getDataAttributes(this._element), ...t }),
				d('modal', t, Ne),
				t
			)
		}
		...
		static jQueryInterface(t, e) {
			return this.each(function () {
				const i =
					Se.getInstance(this) || new Se(this, 'object' == typeof t ? t : {})
				if ('string' == typeof t) {
	...
	H.on(
		...
		b(Se)
	const Ie = { backdrop: !0, keyboard: !0, scroll: !1 },
		je = { backdrop: 'boolean', keyboard: 'boolean', scroll: 'boolean' }
	class Pe extends R {
		constructor(t, e) {
			super(t),
				(this._config = this._getConfig(e)),
	...
	H.on(
		...
		H.on(window, 'load.bs.offcanvas.data-api', () => {
			t.find('.offcanvas.show').forEach(t =>
				(w.get(t, 'bs.offcanvas') || new Pe(t)).show()
			)
		}),
		b(Pe)
	const Me = new Set([
	...
	class Ke extends R {
		...
		show() {
			...
			w.set(s, this.constructor.DATA_KEY, this),
				...
				this._popper
					? this._popper.update()
					: (this._popper = ce(this._element, s, this._getPopperConfig(a))),
		...
		static jQueryInterface(t) {
			return this.each(function () {
				...
				if (
					...
					(e || (e = new Ke(this, i)), 'string' == typeof t)
				) {
	...
	const Xe = new RegExp('(^|\\s)bs-popover\\S+', 'g'),
		...
		Qe = { ...Ke.DefaultType, content: '(string|element|function)' },
		Ge = {
	...
	class Ze extends Ke {
		...
		static jQueryInterface(t) {
			return this.each(function () {
				...
				if (
					(e || !/dispose|hide/.test(t)) &&
					(e || ((e = new Ze(this, i)), w.set(this, 'bs.popover', e)),
					'string' == typeof t)
				) {
					if (void 0 === e[t]) throw new TypeError(`No method named "${t}"`)
					e[t]()
