...
!(function (e, t) {
	...
	function o() {
		...
		if (((e = i), !isNaN(parseFloat(e)) && isFinite(e) && Math.floor(e) == e))
  ...
  */
	...
	function p(e) {
		...
		return new Promise(function (o, i) {
			if (!r(e)) throw new TypeError('“'.concat(e, '” is not a vimeo.com url.'))
			var a = 'https://vimeo.com/api/oembed.json?url='.concat(
				encodeURIComponent(e)
			)
			for (var u in t)
				t.hasOwnProperty(u) &&
					(a += '&'.concat(u, '=').concat(encodeURIComponent(t[u])))
			var l =
	...
	function w(e, t) {
		...
		if ((t = y(t)).event) {
			...
			;(r = f(e, 'event:'.concat(t.event))), (n = t.data)
		} else if (t.method) {
			var o = (function (e, t) {
				var n = f(e, t)
			...
			function t(e) {
						...
						((n._onMessage = function (e) {
							if (r(e.origin) && n.element.contentWindow === e.source) {
								...
								if (
									...
									return (i.name = o.data.name), void a(i)
								}
				...
				if (
					...
					E.on('fullscreenchange', function () {
						E.isFullscreen
							? s(n, 'event:exitFullscreen', f)
							: d(n, 'event:exitFullscreen', f),
						...
						value: function (e) {
							...
							return new l(function (r, o) {
								return t
									.ready()
									.then(function () {
										s(t, e, { resolve: r, reject: o }), g(t, e, n)
									})
									.catch(o)
							})
						}
							...
							return new l(function (r, o) {
								return (
									...
									t
										.ready()
										.then(function () {
											s(t, e, { resolve: r, reject: o }), g(t, e)
										})
										.catch(o)
								)
							})
						...
						value: function (e, t) {
							...
							return new l(function (o, i) {
								...
								return r
									.ready()
									.then(function () {
										s(r, e, { resolve: o, reject: i }), g(r, e, t)
									})
									.catch(i)
							})
						}
