					...
					if (l >= d) {
						...
						if (m) {
							...
							switch (
								...
								g >= 8 &&
									!t.classList.contains('moving-left') &&
									(m.m41 = -2e3),
								g >= 8 &&
									!t.classList.contains('moving-left') &&
								...
								default:
									window.innerWidth >= 2560
										...
										: window.innerWidth >= 1440
											? (translateX1 = m.m41 + 0.55 * (l - d))
											: window.innerWidth >= 1024
												? (translateX1 = m.m41 + 0.45 * (l - d))
												: window.innerWidth >= 768
													? (translateX1 = m.m41 + 0.35 * (l - d))
													: window.innerWidth >= 320 &&
														(translateX1 = m.m41 + 0.25 * (l - d))
							}
						...
						if (w) {
							...
							switch (
								...
								W >= 8 &&
									!e.classList.contains('moving-left') &&
									window.innerWidth < 1200 &&
									(w.m41 = 0),
								!0)
							) {
								...
								default:
									window.innerWidth >= 2560
										? (translateX2 = w.m41 - 0.9 * (l - d))
										: window.innerWidth >= 1440
											? (translateX2 = w.m41 - 0.55 * (l - d))
											: window.innerWidth >= 1024
												? (translateX2 = w.m41 - 0.45 * (l - d))
												: window.innerWidth >= 768
													? (translateX2 = w.m41 - 0.35 * (l - d))
													: window.innerWidth >= 320 &&
														(translateX2 = w.m41 - 0.25 * (l - d))
							}
						...
						if (h) {
							...
							L.forEach(n => {
								...
								y >= 8 &&
									!i.classList.contains('moving-left') &&
									(h.m41 = -2e3),
								y >= 8 &&
									!i.classList.contains('moving-left') &&
									window.innerWidth < 1200 &&
