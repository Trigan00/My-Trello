 ...
 */ !(function (e) {
	...
	function (e, t, n) {
		...
		var v = 0,
					...
					(n = [
						{
							...
							value: function (e, t) {
								return 'string' == typeof t
									? a.window.getComputedStyle(e).getPropertyValue(t)
									: (t.transform && g && (t[g] = t.transform),
							...
							value: function (e) {
								...
								return (
									...
									Object.keys(n).forEach(function (t) {
										n[t] &&
											Object.keys(n[t]).forEach(function (o) {
												e[o] = n[t][o]
											})
									}),
									e
							...
							value: function (e) {
								...
								if (
									(t.options.elementInViewport &&
										(l = t.options.elementInViewport.getBoundingClientRect()),
									(t.isElementInViewport =
										0 <= l.bottom &&
										0 <= l.right &&
										l.top <= p &&
										l.left <= a.window.innerWidth),
									...
									if (
										...
										('opacity' !== t.options.type &&
											...
											((r.transform = 'translate3d(0,0,0)'), (r.opacity = y)),
			...
			w = function (e, t) {
				;('object' ===
				('undefined' == typeof HTMLElement ? 'undefined' : s(HTMLElement))
